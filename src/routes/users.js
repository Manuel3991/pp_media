...
router.get('/',isLoggedIn, async (req, res) => {
  ...
  const users = await pool.query('SELECT user.iduser AS iduser,user.fullname AS fullname,user.username AS username,role.role AS role FROM user JOIN role ON user.idrole=role.idrole');
  console.log(users);
